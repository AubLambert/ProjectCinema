...
class CustomerFormApp(tk.Toplevel):
    def __init__(self, parent, db_connection, screening_id, selected_seats, total_price, movie_window, seat_booking_window):
        super().__init__(parent)
        self.parent = parent
...
#wot da hell
    ...
    def confirm_form(self):
        ...
        if not customer_name and not phone:
            ...
            self.error_label.config(text="Please enter phone number!")
            return
        else:
